...
(cl:defmethod cl:initialize-instance :after ((m <LocalizePart-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalizePart-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moving_core-srv:<LocalizePart-request> is deprecated: use moving_core-srv:LocalizePart-request instead.")))

(cl:ensure-generic-function 'base_frame-val :lambda-list '(m))
(cl:defmethod base_frame-val ((m <LocalizePart-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moving_core-srv:base_frame-val is deprecated.  Use moving_core-srv:base_frame instead.")
  (base_frame m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LocalizePart-request>)))
  ...
  "moving_core/LocalizePartRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocalizePart-request)))
  "Returns string type for a service object of type 'LocalizePart-request"
  "moving_core/LocalizePartRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <LocalizePart-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalizePart-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moving_core-srv:<LocalizePart-response> is deprecated: use moving_core-srv:LocalizePart-response instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <LocalizePart-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moving_core-srv:pose-val is deprecated.  Use moving_core-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LocalizePart-response>)))
  ...
  "moving_core/LocalizePartResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocalizePart-response)))
  "Returns string type for a service object of type 'LocalizePart-response"
  "moving_core/LocalizePartResponse")
