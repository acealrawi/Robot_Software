...
int main(int argc, char** argv)
{
  ...
  const std::string group_name = "manipulator_i5";
...
bool executeTrajectory(const trajectory_msgs::JointTrajectory& trajectory)
{
  ...
  ///aubo_i5_controller/follow_joint_trajectory  or joint_trajectory_action
  actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction> ac ("aubo_i5_controller/follow_joint_trajectory", true);
